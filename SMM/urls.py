...
urlpatterns = [
    ...
    # url(r'^logout/$', 'logout', {'template_name': 'SMM/login.html', 'next_page': reverse('index')},
    #     name='logout'),

    url(r'^signup/$', core_views.signup, name='signup'),
    url(r'^dashboard/$', core_views.insert_value, name='insert_value'),
    url(r'^$', core_views.home, name='home'),
    # url(r'^insert/$', core_views.insert_value, name='insert_keyword'),
